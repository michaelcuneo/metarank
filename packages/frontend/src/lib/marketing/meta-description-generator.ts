export const metaDescriptionGeneratorPage: SeoLandingPageContent = {
	slug: 'meta-description-generator',
	title: 'Meta Description Generator',
	metaTitle: 'Meta Description Generator API — AI SEO Descriptions | MetaRank',
	metaDescription:
		'Generate SEO meta descriptions from real content with MetaRank. AI-powered API for developers, CMS platforms, and publishing workflows.',
