export const searchIntentApiPage: SeoLandingPageContent = {
	slug: 'search-intent-api',
	title: 'Search Intent API',
	metaTitle: 'Search Intent API — Classify Query Intent with AI | MetaRank',
	metaDescription:
		'Classify search intent with MetaRank. AI-powered API for informational, commercial, transactional, and navigational SEO workflows.',
