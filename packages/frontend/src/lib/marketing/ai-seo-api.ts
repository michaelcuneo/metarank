export const aiSeoApiPage: SeoLandingPageContent = {
	slug: 'ai-seo-api',
	title: 'AI SEO API',
	metaTitle: 'AI SEO API — Automated Metadata Generation for Developers | MetaRank',
	metaDescription:
		'Use MetaRank as your AI SEO API for generating titles, descriptions, keywords, slugs, and intent classification from content.',
	eyebrow: 'AI for SEO',
