export const metaTitleGeneratorPage: SeoLandingPageContent = {
	slug: 'meta-title-generator',
	title: 'Meta Title Generator',
	metaTitle: 'Meta Title Generator API — AI SEO Titles | MetaRank',
	metaDescription:
		'Generate SEO meta titles from content with MetaRank. AI-powered API for developers, CMS platforms, and publishing workflows.',
	eyebrow: 'SEO Automation',
	heroTitle: 'Meta Title Generator API',
	heroDescription:
		'Create search-friendly meta titles from real page content using MetaRank. Built for developers, publishing systems, and SEO workflows that need clean metadata at scale.',
	primaryCta: {
	...
	faqs: [
		{
			...
			answer:
				'A good meta title is clear, relevant to the page, and aligned with the target query. MetaRank is designed to produce titles that are readable and useful in search results.'
		},
		{
			question: 'Can I generate titles at scale?',
			answer:
				'Yes. MetaRank is API-first, so it works well for large content sets, CMS workflows, and automated publishing systems.'
		},
		{
			question: 'Does MetaRank only return titles?',
			answer:
				'No. The API also returns descriptions, keywords, slugs, and search intent so you can build a full metadata pipeline.'
		}
	]
};
