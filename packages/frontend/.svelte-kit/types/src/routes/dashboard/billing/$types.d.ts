...
type RouteParams = {  };
type RouteId = '/dashboard/billing';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/dashboard/billing/+page.server.js').load>>>>>>;
