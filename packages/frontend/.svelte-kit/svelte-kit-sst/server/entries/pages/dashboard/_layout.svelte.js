import { g as getContext, b as ensure_array_like, c as attr, a as attr_class, f as store_get, e as escape_html, h as slot, u as unsubscribe_stores } from "../../../chunks/index2.js";
import "clsx";
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!--]--></nav> <div class="sidebar-usage svelte-2agd5u"><p class="usage-label svelte-2agd5u">Usage</p> <div class="usage-bar svelte-2agd5u"><div class="usage-fill svelte-2agd5u" style="width: 21%"></div></div> <p class="usage-meta svelte-2agd5u">42 / 200 requests</p></div></div></aside> <main class="content svelte-2agd5u"><div class="breadcrumb svelte-2agd5u"><span>Dashboard</span> `);
