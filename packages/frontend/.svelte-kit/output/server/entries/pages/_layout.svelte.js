...
function Footer($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<footer class="footer svelte-jz8lnl"><div class="footer-inner svelte-jz8lnl"><div class="footer-brand svelte-jz8lnl"><div class="logo svelte-jz8lnl">MetaRank</div> <p class="tagline svelte-jz8lnl">Predictable SEO metadata for developers and publishing systems.</p></div> <nav class="footer-nav svelte-jz8lnl" aria-label="Footer"><div class="footer-group svelte-jz8lnl"><div class="footer-title svelte-jz8lnl">Product</div> <a href="/generate" class="svelte-jz8lnl">Generate</a> <a href="/pricing" class="svelte-jz8lnl">Pricing</a> <a href="/about" class="svelte-jz8lnl">About</a></div> <div class="footer-group svelte-jz8lnl"><div class="footer-title svelte-jz8lnl">Developers</div> <a href="/docs" class="svelte-jz8lnl">Docs</a> <a href="https://github.com/your-org/metarank" target="_blank" rel="noopener" class="svelte-jz8lnl">GitHub</a></div> <div class="footer-group svelte-jz8lnl"><div class="footer-title svelte-jz8lnl">Company</div> <a href="mailto:hello@metarank.io" class="svelte-jz8lnl">Contact</a></div> <div class="footer-group svelte-jz8lnl"><div class="footer-title svelte-jz8lnl">Service Status</div> `);
    ApiStatus($$renderer2);
